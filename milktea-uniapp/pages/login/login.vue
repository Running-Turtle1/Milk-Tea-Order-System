		...
		<view class="login-content">
			<view class="login-header">
				...
				<view class="title-group">
					<text class="title">奶茶物语</text>
					<text class="subtitle">Milk Tea Story</text>
				</view>
			</view>
			
			<view class="login-form glass-card">
				<view class="form-heading">
					<text class="heading-text">欢迎回来</text>
				...
				<view class="input-group">
					...
					<view class="input-wrapper">
						...
						<input class="input-box" type="text" placeholder="用户名或手机号" v-model="username" />
					</view>
				</view>
				...
				<view class="agreement-row">
					<view class="checkbox-container" @click="toggleAgreement">
						<view class="checkbox" :class="{'checked': agreedToTerms}">
							<text v-if="agreedToTerms" class="checkbox-inner">✓</text>
						</view>
					</view>
				...
				<button class="login-btn" :class="{'login-btn-disabled': !agreedToTerms}" :disabled="!agreedToTerms" @click="handleLogin">
				...
				<view class="action-links">
					...
					<text class="register" @click="goToRegister">立即注册</text>
				</view>
			</view>
			
			<view class="slogan">用心调制，每一杯都是独特体验</view>
		</view>
	</view>
</template>
...
<style>
	...
	.checkbox {
		width: 32rpx;
		height: 32rpx;
		border: 1rpx solid rgba(112, 102, 226, 0.5);
		border-radius: 6rpx;
		display: flex;
		justify-content: center;
		align-items: center;
