...
import { createProduct, getCategoryList, uploadProductImage } from '../../api/admin'
...
const submitForm = async () => {
  ...
  try {
    ...
    ElMessage.error('商品创建失败: ' + (error.message || '未知错误'))
  } finally {
    ...
    <div class="form-card">
      ...
      >
        ...
        <el-form-item class="form-buttons">
          ...
          <el-button type="primary" @click="submitForm" :loading="submitLoading" class="submit-button">创建商品</el-button>
        </el-form-item>
      </el-form>
    </div>
  </div>
